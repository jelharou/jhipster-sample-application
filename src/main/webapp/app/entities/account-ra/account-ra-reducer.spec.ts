...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTRA_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCOUNTRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTRA actions', async () => {
      const expectedActions = [
        {
