...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BENEFICIARY_LIST actions', async () => {
    ...
    it('dispatches FETCH_BENEFICIARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BENEFICIARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BENEFICIARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BENEFICIARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BENEFICIARY actions', async () => {
      const expectedActions = [
        {
