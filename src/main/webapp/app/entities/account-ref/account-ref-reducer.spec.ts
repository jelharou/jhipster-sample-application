...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTREF_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCOUNTREF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTREF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTREF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTREF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTREF actions', async () => {
      const expectedActions = [
        {
