...
import { getEntity, deleteEntity } from './party.reducer';

export const PartyDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.party.delete.question">Are you sure you want to delete this Party?</ModalBody>
      <ModalFooter>
