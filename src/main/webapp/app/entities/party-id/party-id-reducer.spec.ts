...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './party-id.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTYID_LIST actions', async () => {
    ...
    it('dispatches FETCH_PARTYID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARTYID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARTYID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARTYID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARTYID actions', async () => {
      const expectedActions = [
        {
