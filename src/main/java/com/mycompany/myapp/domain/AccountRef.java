...
public class AccountRef implements Serializable {
    ...
    public AccountRA getAccountRA() {
        return this.accountRA;
    }

    public void setAccountRA(AccountRA accountRA) {
        if (this.accountRA != null) {
            this.accountRA.setAccountRef(null);
        }
        if (accountRA != null) {
            accountRA.setAccountRef(this);
        }
        this.accountRA = accountRA;
    }

    public AccountRef accountRA(AccountRA accountRA) {
        this.setAccountRA(accountRA);
        return this;
    }
